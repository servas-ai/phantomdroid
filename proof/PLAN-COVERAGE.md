...
- **Pin-enforcement generalization:** the same declarative-vs-enforced gap exists for `local-module-file-sha256-match` (cpuinfo_overlay `file_sha256` declared required-before-compose-up but not code-enforced) — next work-item.
